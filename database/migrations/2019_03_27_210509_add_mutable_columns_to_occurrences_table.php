...
class AddMutableColumnsToOccurrencesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('occurrences', function (Blueprint $table) {
            $table->dropColumn('NumeroMeiosAereosEnvolvidos');
            $table->dropColumn('NumeroMeiosTerrestresEnvolvidos');
            $table->dropColumn('NumeroOperacionaisAereosEnvolvidos');
            $table->dropColumn('NumeroOperacionaisTerrestresEnvolvidos');
